...
public class AdminBookingDetailViewController implements Initializable{
	@FXML
    ...
    void setBookingDetail(Reservation rsvpObj) throws SQLException {
    	
    	bookingNoTxt.setText(String.valueOf(rsvpObj.getBookingId()));
    	
    	double total = rsvpObj.getTotalPrice();
    	System.out.println("In side ddet Booking Detail-> Total Price: " + total);
